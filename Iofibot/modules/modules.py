...
from Iofibot import dispatcher, telethn
from Iofibot.__main__ import (
    CHAT_SETTINGS,
    DATA_EXPORT,
    DATA_IMPORT,
    HELPABLE,
...
def load(update: Update, context: CallbackContext):
    ...
    try:
        imported_module = importlib.import_module("Iofibot.modules." + text)
    except:
...
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("Iofibot.modules.", 1)[1]

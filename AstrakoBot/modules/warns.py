...
import telegram
from Iofibot import WOLVES, dispatcher
...
from Iofibot.modules.helper_funcs.misc import split_message
from Iofibot.modules.helper_funcs.string_handling import split_quotes
from Iofibot.modules.log_channel import loggable
from Iofibot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Iofibot's sticker
        keyboard = None
        log_reason = (
